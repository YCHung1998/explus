# https://github.com/open-mmlab/mmaction2/blob/4d6c93474730cad2f25e51109adcf96824efc7a3/mmaction/evaluation/functional/eval_detection.py. #noqa
...
class ActivityNetLocalization:
    ...
    def _import_ground_truth(ground_truth_filename):
        ...
        for video_id, video_info in data.items():
            ...
            for anno in video_info['annotations']:
                ...
                # old video_anno
                ground_truth_item = {}
                ground_truth_item['video-id'] = video_id  # video path / name
        ...
        if activity_index == {}:
            print("Warning: activity_index is empty.")
            activity_index[0] = 0  # to avoid empty activity_index error

        # print("ground_truth", ground_truth)
        # print("activity_index", activity_index)
        # print("anno['label']", anno['label'])
    ...
    def _import_prediction(self, prediction_filename):
        ...
        for video_id, video_info in data['results'].items():
            for result in video_info:
                ...
                prediction_item['video-id'] = video_id  # video path / name

                if self.activity_index != {0: 0}:
                    prediction_item['label'] = \
                        self.activity_index[result['label']]
                else:
                    # for empty activity_index case
    ...
    def wrapper_compute_average_precision(
        self,
        ground_truth=None,
        prediction=None
    ):
